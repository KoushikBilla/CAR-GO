...
USE cargo#
SELECT DATABASE()#
DROP PROCEDURE IF EXISTS proc_get_booking_info_v1dot0#

CREATE PROCEDURE proc_get_booking_info_v1dot0(
...
BEGIN
        ...
        BEGIN
                ...
                SET out_err_msg = CONCAT('proc_get_booking_info_v1dot0',out_err_msg);
                SET out_status = 500;
        ROLLBACK;
        END;
        ...
        BEGIN
                ...
                where booking_info.c_booking_info_id = in_booking_info_id;
                ...
                where booking_cart.c_booking_info_id = in_booking_info_id;
                ...
                where booking_promo.c_booking_info_id = in_booking_info_id;
